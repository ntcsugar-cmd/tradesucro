...
import { Home, TrendingUp, Handshake, BellRing, User } from "lucide-react";
 ...
 * top of it when the person needs the rest of the navigation.
 */
export function BottomNav({ homeHref = "/dashboard", alertCount = 0 }: BottomNavProps) {
