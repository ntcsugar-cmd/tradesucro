...
export function BuyRequirements() {
  return (
    <section className="border-b border-line bg-charcoal/[0.02]">
            ...
            >
              <div className="col-span-2 md:col-span-1">
                <div className="flex items-center gap-2">
                  <p className="font-body font-medium text-[14.5px] text-charcoal">{req.buyer}</p>
                  {req.urgent && (
                ...
                <p className="text-xs text-ink-faint mt-0.5">{req.location}</p>
              </div>
              ...
              <div className="text-xs text-ink-faint self-center">{req.postedAgo}</div>
            </motion.div>
          ))}
        </div>
      </div>
